...
### The architecture and functional logic of the solution are the author's work. The Gemini (Google) model was used during development to review the code syntax, optimize error conditions, and ensure script stability.
